...
public static function update($username) {
    $db = Db::getInstance();
    $req = $db->prepare("Update USER_TABLE set FirstName=:firstname, LastName=:surname, EmailAddress=:email, ProfilePhoto=:profilepic where Username=:username");
...
//    if (!empty($_FILES[self::InputKey]['profilepic'])) {
//        $updateprofilepic = 'views/images/profilepics/'.$filteredUsername.'.jpeg';
//    }
...
public static function uploadFile(string $name) {
	...
	$tempFile = $_FILES[self::InputKey]['tmp_name'];
        //$path = "../views/images/profilepics/";
        $path = "/Applications/XAMPP/xamppfiles/htdocs/LAS_MVC/views/images/profilepics/";
